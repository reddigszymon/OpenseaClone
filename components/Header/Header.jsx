...
function Header({titles, fullData, etherPrice}) {
    ...
    const styles = {
        ...
        navbarContainer: `xl:max-w-[800px] xl:ml-auto w-full hidden sm:flex items-center justify-center border-2 dark:border-0 bg-white dark:bg-[#2b2a33] rounded-lg`,
        searchIconSpace: `text-2xl mx-3`,
        searchIconColor: `text-[#8a939b]`,
        input: `outline-none lg:max-w-[1000px] rounded-lg text-black dark:text-white flex-1 dark:bg-[#2b2a33] text-base p-2 outline-0 `,
